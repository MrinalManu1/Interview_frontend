  ...
  return (
    <div className="flex min-h-screen bg-slate-950 text-slate-100 font-sans relative overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 z-10">
        <div className="bg-slate-900/40 backdrop-blur-md border border-slate-900 p-10 rounded-3xl shadow-2xl max-w-md w-full flex flex-col">
          ...
          <p className="text-slate-400 font-outfit text-sm text-center mb-8 mt-1">Sign in to your coding sandbox</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex flex-col space-y-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-slate-950/80 border border-slate-900 focus:border-orange-500/80 focus:ring-1 focus:ring-orange-500/20 text-slate-100 placeholder-slate-600 rounded-2xl focus:outline-none transition-all duration-300 font-medium"
              />
            </div>
          ...
          <p className="text-center text-slate-500 font-outfit text-[14px] mt-6 border-t border-slate-900/60 pt-5">
            ...
            <Link to="/register" className="text-orange-400 font-bold hover:text-orange-300 hover:underline">
              Create Account
            </Link>
          </p>
        </div>
